...
`Archive` is the high-level API for concurrent appends plus non-destructive range reads.

Use it when many producers write at once and you want buffered concurrent appends.
