...
`Journal` is the low-policy API: sequential append, explicit `Sync`, non-destructive `Range`, and explicit prefix/suffix truncation.

Use it when your application owns commit boundaries and retention decisions.
